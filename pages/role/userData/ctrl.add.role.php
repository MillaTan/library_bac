...
if (isset($_POST['submit'])) {
    ...
    if ($check == 0) {
        ...
        // $insert_log = mysqli_query($conn, "INSERT INTO tbl_logs (username, role, action, sp_action, link) VALUES ('$_SESSION[username]', '$_SESSION[user_role]', 'Add Role', '$role', 'ctrl.add.role.php')");
