...
<head>
  ...
  <style>
    .login-page {
      background-image: url('../../dist/img/sfac.png');
    ...
    <div class="login-box">
      ...
      <div class="card card-outline card-danger">
        <div class="card-header text-center">
          <div class="sfac-logo">
            <img src="../../dist/img/stfrancis.png" alt="sfac" style="width:80px;height:80px;">
          </div>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col">
                ...
                <form id="loginForm" action="userData/ctrl.login.php" method="POST">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-auto">
                      <a href="../register/add.register.php" name="signin" class="btn btn-primary ">Register</a>
